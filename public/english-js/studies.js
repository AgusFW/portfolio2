document.addEventListener('DOMContentLoaded', async () => {
    ...
    function renderViewModalEstContent(estudio) {
        ...
        <p><b>Period:</b> ${estudio.periodo}</p>
        <p><b>Languages/Libraries:</b> ${estudio.lenguajes}</p>
        <p><b>Description:</b> ${estudio.descripcion}</p>
    ...
    saveChangesBtnModalEst.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(`/education/${currentEstudioId}`, {
                method: 'PUT',
                headers: {
